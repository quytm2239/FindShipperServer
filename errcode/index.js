module.exports={
    ...
    code_null_invalid_account_type: 'Your type is not valid (0 - seller, 1 - shipper)',
    ...
    errorMessage: function (code) {
    	...
    	case module.exports.code_null_invalid_birthday:
    		mess = "birthday is blank/null or not valid. (dd/mm/yyyy)";
    		break;
        ...
        case module.exports.code_invalid_max_age:
            mess = "max_age is invalid (<= 40).";
            break;
        case module.exports.code_invalid_age:
            mess = "Your age is not valid to use app (18 - 40).";
            break;
        case module.exports.code_need_birthday:
            mess = "No birthday provided, required age to use this app is 18 - 40.";
            break;
